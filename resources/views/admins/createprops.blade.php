      ...
      <div class="card">
        <div class="card-body">
                ...
                <form method="POST" action="{{ route('props.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4 mt-4">
                        <input type="text" name="home_type" id="home_type" class="form-control" placeholder="HomeType" />
                      </div> 
                    ...
                    <div class="form-outline mb-4 mt-4">
                        <input type="text" name="type" id="form2Example1" class="form-control" placeholder="type" />
                      </div> 
                  ...
                  <div class="form-outline mb-4 mt-4">
                    <input type="text" name="city" id="form2Example1" class="form-control" placeholder="city" />
                  </div> 
