                ...
                <div class="row align-items-end">
                    <div class="col-md-3">
                        ...
                        <div class="input-wrap">
                            <input type="text" name="list_types" id="list-types" class="form-control d-block rounded-0" placeholder="Enter listing type"/>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label for="offer-types">Offer Type</label>
                        <div class="input-wrap">
                            <input type="text" name="offer_types" id="offer-types" class="form-control d-block rounded-0" placeholder="Enter offer type"/>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label for="select-city">Select City</label>
                        <div class="input-wrap">
                            <input type="text" name="select_city" id="select-city" class="form-control d-block rounded-0" placeholder="Enter city"/>
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
            ...
            <div class="ml-auto d-flex align-items-center">
                <div>
                    ...
                    <a href="{{ route('price.asc.prop') }}" class="view-list px-3">Price By Ascending</a>
                    <a href="{{ route('price.desc.prop') }}" class="view-list px-3">Price By Descending</a>
                </div>
